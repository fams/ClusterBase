...
ClusterPkt::ClusterPkt(const char *name, int kind) : cPacket(name,kind)
{
    this->msgtype_var = 0;
    this->headId_var = 0;
    this->originId_var = 0;
...
ClusterPkt::ClusterPkt(const ClusterPkt& other) : cPacket(other)
{
    copy(other);
}
...
ClusterPktDescriptor::ClusterPktDescriptor() : cClassDescriptor("ClusterPkt", "cPacket")
{
}
